...
//     static attributes = { dataIsland: 'data-island' }
...
//                 const conditionPromises = conditionFunction(conditionsAttributeMap[condition])
//             }
//         }
//         await Promise.all(condition)
//         // hydration should happen after some condition
//         const relevantChildTemplate = this.getTemplates()
//         this.replaceTemplates(relevantChildTemplate)
//     }
...
// } else {
//     console.error('island  cannot be initiated')
// }
